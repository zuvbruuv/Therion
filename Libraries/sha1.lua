local common = loadstring(game:HttpGet('https://raw.githubusercontent.com/raphtalia/RbxFingerprint/refs/heads/main/src/sha1/common.lua'))()
local ops = loadstring(game:HttpGet('https://raw.githubusercontent.com/raphtalia/RbxFingerprint/refs/heads/main/src/sha1/bit32_ops.lua'))()
