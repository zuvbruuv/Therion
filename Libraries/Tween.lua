...
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/zuvbruuv/Therion/refs/heads/main/Libraries/Signal.lua"))()
...
function Tween:Play()
    ...
    for property, value in next, self._properties do
        ...
        spawn(function()
            ...
            if not self._cancelled and self._object then
