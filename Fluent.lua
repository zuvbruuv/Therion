...
local ClosureBindings = {
	...
	function()local wax,script,require=ImportGlobals(2)local ImportGlobals return (function(...)local Acrylic = {
	...
	function()local wax,script,require=ImportGlobals(3)local ImportGlobals return (function(...)local Creator = require(script.Parent.Parent.Creator)
	...
	function()local wax,script,require=ImportGlobals(4)local ImportGlobals return (function(...)local Creator = require(script.Parent.Parent.Creator)
	...
	function()local wax,script,require=ImportGlobals(5)local ImportGlobals return (function(...)local Root = script.Parent.Parent
			local Creator = require(Root.Creator)
	...
	function()local wax,script,require=ImportGlobals(6)local ImportGlobals return (function(...)local function map(value, inMin, inMax, outMin, outMax)
	...
	[8] = function()local wax,script,require=ImportGlobals(8)local ImportGlobals return (function(...)return {
	...
	[13] = function()local wax,script,require=ImportGlobals(13)local ImportGlobals return (function(...)local Root = script.Parent.Parent
			local Creator = require(Root.Creator)
	...
	[15] = function()local wax,script,require=ImportGlobals(15)local ImportGlobals return (function(...)local TextService = game:GetService("TextService")
			local Root = script.Parent.Parent
			local Flipper = require(Root.Packages.Flipper)
			local Creator = require(Root.Creator)
			local New = Creator.New
	...
	[16] = function()local wax,script,require=ImportGlobals(16)local ImportGlobals return (function(...)local Root = script.Parent.Parent
			...
			return function(Config)
				...
				local Logo = New("ImageLabel", {
					...
					BorderSizePixel = 0,
					Position = UDim2.fromOffset(0.5, 19),
	...
	[17] = function()local wax,script,require=ImportGlobals(17)local ImportGlobals return (function(...)-- i will rewrite this someday
			local UserInputService = game:GetService("UserInputService")
			local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
			local Camera = game:GetService("Workspace").CurrentCamera
	...
	[18] = function()local wax,script,require=ImportGlobals(18)local ImportGlobals return (function(...)local Root = script.Parent
	...
	[19] = function()local wax,script,require=ImportGlobals(19)local ImportGlobals return (function(...)local Elements = {}
	...
	[21] = function()local wax,script,require=ImportGlobals(21)local ImportGlobals return (function(...)local UserInputService = game:GetService("UserInputService")
			...
			function Element:New(Idx, Config)
				...
				local DisplayFrame = New("ImageLabel", {
					...
					Position = UDim2.new(1, (Config.Toggle and -10) or -10, 0.5, 0),
					AnchorPoint = Vector2.new(1, 0.5),
					Parent = ColorpickerFrame.Frame,
	...
	[22] = function()local wax,script,require=ImportGlobals(22)local ImportGlobals return (function(...)local TweenService = game:GetService("TweenService")
			local UserInputService = game:GetService("UserInputService")
			local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
			local Camera = game:GetService("Workspace").CurrentCamera
			...
			function Element:New(Idx, Config)
				...
				Creator.AddSignal(UserInputService.InputBegan, function(Input)
					...
					then
						...
						then
							Dropdown:Close()
							Textbox.Frame.Frame.TextBox.TextTransparency = 1
							Dropdown:Display()
						end
					end
				end)
                ...
                Textbox.Frame.Frame.TextBox:GetPropertyChangedSignal("Text"):Connect(function()
                    DropdownDisplay.Text = Textbox.Frame.Frame.TextBox.Text
                    if Textbox.Frame.Frame.TextBox.Text ~= "" then
                        ...
                        for Idx, Value in pairs(Values) do
                            ...
                            if string.find(string.lower(Value), SearchText) then
                                local Button = DropdownScrollFrame:FindFirstChild(Value)
                                if Button then
                                    Button.Visible = true
                                else
                                    local Table = {}
	...
	[25] = function()local wax,script,require=ImportGlobals(25)local ImportGlobals return (function(...)local UserInputService = game:GetService("UserInputService")
			...
			function Element:New(Idx, Config)
				...
				do 
					if Config.Toggle then	
						assert(Config.Toggle and Config.Toggle.Flag, "Bind Toggle - Missing flag!")
	...
	[29] = function()local wax,script,require=ImportGlobals(29)local ImportGlobals return (function(...)-- This file was @generated by Tarmac. It is not intended for manual editing.
			return {
				assets = {
					...
					["lucide-fish"] = "rbxassetid://121162010970052",
					["lucide-house-plug"] = "rbxassetid://98958248521757",
    ...
    [55] = function()local wax,script,require=ImportGlobals(55)local ImportGlobals return (function(...)return {
        ...
        AcrylicBorder = Color3.fromRGB(50, 55, 60),
        ...
        DialogButtonBorder = Color3.fromRGB(60, 60, 65),
        DialogBorder = Color3.fromRGB(55, 55, 60),
        DialogInput = Color3.fromRGB(40, 40, 45),
